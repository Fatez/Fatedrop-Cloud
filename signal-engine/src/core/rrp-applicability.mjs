...
export function classifyRrpApplicability({ title = "", productType = "other" } = {}) {
  ...
  if (/\b(?:japanese|japan import|japanese import|jp|korean|korea import|korean version|kr|simplified chinese|traditional chinese|chinese simplified|chinese import|chinese|cn)\b/.test(text)) {
