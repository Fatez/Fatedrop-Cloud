...
const store={
  ...
  async listProducts(){return[{id:"product-1",title:"Destined Rivals Elite Trainer Box",productType:"sealed",officialRrpPence:4999,rrpSource:"pokemon-center-uk",rrpObservedAt:1776767000}];},
